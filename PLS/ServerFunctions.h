...
namespace CMonsterReal
{
	...
	static int(__thiscall *Tick) (void* Monster) = (int(__thiscall*)(void*))0x0043D140;
...
namespace CItem
{
	...
	static int(__thiscall *Transform)(int thispointer, int a2) = (int(__thiscall*)(int thispointer, int a2))0x0042E5E0;
}
...
namespace CParty
{
	...
	static signed int(__thiscall *Teleport)(int a5, int a6) = (signed int(__thiscall*)(int a5, int a6))0x0044E830;
}
...
namespace CGuild
{
	static char(__thiscall *IsMemberFull)(int k) = (char(__thiscall*)(int))0x00415F20;
	static int(__thiscall *GetGuild)(void* thispointer) = (int(__thiscall*)(void*))0x0046AAD0;
