...
void __fastcall CallOfEvasion(IChar IPlayer, int pPacket, int pPos)
{
	ISkill ISkill((void*)IPlayer.GetSkillPointer(27));
...
void __fastcall CallOfOTP(IChar IPlayer, int pPacket, int pPos)
{
	ISkill ISkill((void*)IPlayer.GetSkillPointer(31));
...
void __fastcall CallOfRecovery(IChar IPlayer, int pPacket, int pPos)
{
	ISkill ISkill((void*)IPlayer.GetSkillPointer(23));
...
void __fastcall CallOfPhysicalAttack(IChar IPlayer, int pPacket, int pPos)
{

	ISkill ISkill((void*)IPlayer.GetSkillPointer(32));
...
void __fastcall CallOfDefense(IChar IPlayer, int pPacket, int pPos)
{
	ISkill ISkill((void*)IPlayer.GetSkillPointer(19));
...
void __fastcall CallOfHeal(IChar IPlayer, int pPacket, int pPos)
{
	ISkill ISkill((void*)IPlayer.GetSkillPointer(29));
...
void __fastcall CallOfPuri(IChar IPlayer, int pPacket, int pPos)
{
	ISkill ISkill((void*)IPlayer.GetSkillPointer(28));
