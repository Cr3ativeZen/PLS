...
{
	if (this->IsOnline())
		return *(DWORD*)((int)this->GetOffset() + 456l);
	else
		return 0;
}
...
{
	if (this->IsOnline())
		return *(DWORD*)((int)this->GetOffset() + 128l);
	else
		return 0;
}
...
{
	if (this->IsOnline())
		return *(DWORD*)((int)this->GetOffset() + 132l);
	else
		return 0;
}
...
{
	if (this->IsOnline())
		return *(DWORD*)((int)this->GetOffset() + 136l);
	else
		return 0;
}
...
{
	if (this->IsOnline())
		return *(DWORD*)((int)this->GetOffset() + 140l);
	else
		return 0;
}
